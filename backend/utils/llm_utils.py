...
async def generate_openai_parsed_completion_with_stats(
...
) -> tuple[T, dict | None, bool]:
    """Generates a completion using OpenAI and returns (parsed_result, token_usage, from_cache)."""
    ...
    if cached_data:
        ...
        try:
            ...
            parsed = response_model.model_validate(cached_data)
            # For cached responses, return empty token usage
    ...
    async with sema:
        try:
            ...
            return result, token_usage, False
